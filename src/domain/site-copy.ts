...
export const siteCopySchema = z.object({
  ...
  product: z.object({
    ...
    sizeLabel: text,
    framingLabel: text,
    printSizes: z.array(z.object({ id: text, label: text, dimensions: text })).length(3),
    framingOptions: z.array(z.object({ id: text, label: text, detail: text })).length(2),
